...
# 인덱스에서 Date를 열로 변환 (index 열이 생긴 경우 이름을 Date로 변경)
kospi_data = kospi_data.reset_index()

sp500_data = sp500_data.reset_index()
sp500_data.rename(columns={'index': 'Date'}, inplace=True)  # 'index' 열을 'Date'로 변경
...
cols = ['Open', 'High', 'Low', 'Close', 'Volume', 'Asset_KOSPI', 'Asset_S&P500']
