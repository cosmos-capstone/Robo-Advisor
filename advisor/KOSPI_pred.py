...
def predict_future_kospi(future_days=120):
    # 현재 날짜 설정
    ...
    for i in range(seq_len, len(stock_data_scaled) - future_days):
        ...
        trainY.append(stock_data_scaled[i + future_days, 0])
    ...
    # 120일 후의 값을 예측
    last_sequence = stock_data_scaled[-seq_len:] 
    ...
    # 예측한 코스피 지수와 날짜 리턴
    return future_predicted_price, future_date
